...
class UpdateService {
  ...
  static const String _repoUrl = 'https://api.github.com/repos/Monody12/FocusTime/releases/latest';
    ...
    try {
      ...
      if (_isNewerVersion(latestVersion, currentVersion)) {
        ...
        return UpdateInfo(
          ...
          htmlUrl: data['html_url'] ?? 'https://github.com/Monody12/FocusTime/releases/latest',
        );
      }
