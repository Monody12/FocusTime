...
class CalendarService {
  ...
  static Future<bool> _doEnsureCalendar() async {
    ...
    if (Platform.isAndroid) {
      final androidCalendar = await _androidCalendarPlugin.ensureLocalCalendar(
        _calendarName,
      );
    ...
    if (calendars.isSuccess && calendars.data != null) {
      final existing = calendars.data!
          .where((c) => c.name == _calendarName)
          .firstOrNull;
      if (existing != null) {
